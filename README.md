...
When using compiled mode, code at the deeper levels of the call stack that are stepped over will be executed (i.e. code in the current scope and calling scopes will still be interpreted) by the normal julia compiler and run just as fast as normally.
